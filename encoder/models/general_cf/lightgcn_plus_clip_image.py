...
class LightGCN_plus_clip_image(BaseModel):
    def __init__(self, data_handler):
        super(LightGCN_plus_clip_image, self).__init__(data_handler)
        ...
        self.item_image_embeds = t.tensor(
            configs['item_image_embeds']
        ).float().cuda()
    ...
    def cal_loss(self, batch_data):
        ...
        itmprf_embeds = self.image_projection(
            self.item_image_embeds
        )
